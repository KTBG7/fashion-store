...
const CollectionsSection = () => {
  ...
  return (
    <section className="col-span-full custom-col-container w-full  grid-cols-12 gap-y-8 h-fit">
                ...
                <Image
                  className={
                    collection.collection_id !== "cozy"
                      ? "aspect-[319/337] group tablet:aspect-[338/276] containerMax:aspect-[594/276] object-cover relative rounded-lg hover:bg-gradient-to-b hover:from-black hover:to-black hover:bg-opacity-40 "
                  ...
                  quality={45}
                  width={594}
                  height={collection.collection_id !== "cozy" ? 276 : 580}
